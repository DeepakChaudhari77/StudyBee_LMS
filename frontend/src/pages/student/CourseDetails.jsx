    ...
    <>
      <div className='flex lg:flex-row flex-col-reverse mx-auto gap-10 relative items-start justify-between md:px-40 px-8 md:pt-40 pt-20 text-left'>
        ...
        <div className='max-w-2xl z-10 text-gray-500'>
          <h1 className='md:text-4xl text-black font-semibold text-2xl'>{courseData.courseTitle}</h1>
          <p className='pt-4 md:text-[18px] text-base' dangerouslySetInnerHTML={{ __html: courseData.courseDescription.slice(0, 200) }}></p>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Deepak Chaudhari</span></p>
